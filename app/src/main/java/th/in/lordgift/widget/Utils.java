...
public class Utils {
    ...
    /**
     * insert comma into normalNumber
     ...
     * @return formatted number
     */
    protected static String insertIdCardHyphen(String normalNumber) {
        if (TextUtils.isEmpty(normalNumber)) return "";
     ...
     *
     * @param id thai people id
     * @return true if the id is valid
     */
    protected static boolean checkPID(String id) {
