...
public class EmptyView extends RelativeLayout {
    ...
    @Override protected void onFinishInflate() {
        ...
        container = (LinearLayout) root.findViewById(R.id.empty_layout);
        container.setTag(TAG);
        imageView = (ImageView) root.findViewById(R.id.empty_icon);
        textView = (TextView) root.findViewById(R.id.empty_text);
        button = (Button) root.findViewById(R.id.empty_button);
        progressBar = (ProgressBar) root.findViewById(R.id.empty_progress_bar);
