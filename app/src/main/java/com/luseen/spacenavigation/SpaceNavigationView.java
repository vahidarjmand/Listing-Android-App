...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            centreButtonIcon = typedArray.getResourceId(R.styleable.SpaceNavigationView_centre_button_icon, R.drawable.add_new_item_icon);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (centreButtonIcon == NOT_DEFINED)
            centreButtonIcon = R.drawable.add_new_item_icon;
        ...
        if (inActiveCentreButtonIconColor == NOT_DEFINED)
            inActiveCentreButtonIconColor = ContextCompat.getColor(context, R.color.space_white);
    ...
    private void initAndAddViewsToMainView() {
        ...
        mainContent.setBackgroundResource(R.drawable.bottom_bar_bg);
        ...
        centreContent.bringToFront();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            centreContent.setZ(2222f);
            centreContent.setTranslationZ(22222f);
        }
    ...
    public int getCenterButtonLeft(){
        return  centerLeft;
    }
